        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                ...
                <div class="relative">
                    ...
                    <div class="dropdown-menu absolute hidden right-0 top-[66px] w-[270px] flex-col gap-4 p-5 border border-[#EEEEEE] bg-white rounded-[18px] transition-all duration-300 shadow-[0_10px_16px_0_#0A090B0D]">
            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-[30px] mt-2">
                    ...
                    @empty
                        <p>Kelas belum memiliki sebuah test.</p>
                    @endforelse
